...
export function PromptStudioPage() {
  ...
  const runTest = async () => {
    ...
    setTestOutput(`[${prompt.name} Response]\n\nBased on the input "${testInput}", here is my analysis:\n\n• Key insight: The data suggests strong momentum in this direction.\n• Recommendation: Prioritize the top 3 opportunities immediately.\n• Risk assessment: Low risk, high reward scenario.\n• Next action: Deploy Creator Agent with these parameters.\n\n[Response generated by ${prompt.name} · Powered by GPT-4o]`);
    setTesting(false);
  };
