...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    agentTerminalActive: "Active Session",
    agentTerminalDesc: "Send operational prompts and task requests.",
    selectWorker: "Select Agent Worker:",
  ...
  ar: {
    ...
    // AI Chat
    aiChatSessions: "جلسات محادثة الذكاء الاصطناعي",
    newChat: "+ جديد",
    chatConsole: "وحدة المحادثة",
    chatDesc: "تفاعل مباشرة مع نماذج الذكاء الاصطناعي.",
    agentTerminal: "نافذة الوكيل",
    agentTerminalActive: "جلسة نشطة",
    agentTerminalDesc: "أرسل أوامر تشغيلية ومهام فورية للوكيل للقيام بها.",
    selectWorker: "اختر الوكيل:",
    noActiveAgents: "لا يوجد وكلاء",
    model: "النموذج",
    reasoning: "تفكير الذكاء الاصطناعي",
    askAnything: "اسأل النموذج عن أي شيء...",
    send: "إرسال",
    thinking: "يفكر...",
