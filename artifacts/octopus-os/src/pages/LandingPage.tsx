    ...
    <div className="min-h-screen bg-[#0a0614] text-white flex flex-col font-sans selection:bg-purple-500 selection:text-white overflow-x-hidden">
      ...
      <header className="border-b border-purple-900/40 bg-[#0d0920]/80 backdrop-blur-md sticky top-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <a href="/" className="flex items-center gap-3">
            <img src="/logo-1024.jpg" alt="OCTOPUS AI OS" className="w-10 h-10 rounded-xl border border-purple-500/40 shadow-lg shadow-purple-500/30 object-cover" />
            <div>
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-purple-200">
            ...
            <a href="/demo" className="text-cyan-400 hover:text-cyan-300 transition-colors flex items-center gap-1 font-bold">
          ...
          <div className="flex items-center gap-3">
            <a
              href="/demo"
              className="md:hidden bg-[#130d2a] border border-purple-800 text-cyan-300 px-3 py-1.5 rounded-xl text-xs font-bold"
            >
              ▶ Demo
            </a>
            <a
              href="/login"
              className="bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-600 hover:opacity-90 text-white font-bold px-5 py-2.5 rounded-xl text-sm transition-all shadow-lg shadow-purple-900/50 flex items-center gap-2"
            >
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10" dir="rtl">
          ...
          <div className="mt-16 flex flex-col items-center justify-center">
            <div className="relative group">
              ...
              <img
                src="/logo-1024.jpg"
                alt="OCTOPUS AI OS Logo"
                className="relative w-48 h-48 md:w-64 md:h-64 rounded-3xl border border-purple-500/40 shadow-2xl object-cover transform transition-transform duration-500 group-hover:scale-105"
              />
            </div>
            <span className="text-xs font-mono text-purple-400 mt-4 tracking-widest uppercase">OCTOPUS 1024×1024 Emblem</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                step: "01",
                title: "صيد الترند واختيار المنتج",
                icon: "🔍",
                desc: "يقوم الوكيل TrendHunter بمسح الشبكات الاجتماعية واكتشاف المواضيع الأكثر انتشاراً، ثم يختار منتج أفلييت عالي العمولة من Digistore24 أو Clickbank يطابق الترند.",
              },
              {
                step: "02",
                title: "كتابة السكربت الإعلاني المبتكر",
                icon: "✍️",
                desc: "يقوم الوكيل Creator Agent بصياغة سيناريو إعلاني قصير جذاب ومدروس نفسياً لتحقيق أعلى معدل الاحتفاظ بالمشاهدين (Retention Rate) والنقرات.",
              },
              {
                step: "03",
                title: "توليد الصوت والفيديو بالـ AI",
                icon: "🎬",
                desc: "يتم استدعاء محركات ElevenLabs لتوليد صوت بشري طبيعي باللغة العربية أو الإنجليزية، ومحركات HeyGen لتوليد فيديو 9:16 احترافي بأفاتار يتحدث بطلاقة.",
              },
              {
                step: "04",
                title: "النشر التلقائي على القنوات",
                icon: "🚀",
                desc: "يتولى الوكيل Publisher الرفع والنشر المباشر عبر بروتوكولات الـ API الرسمية على TikTok و YouTube Shorts مع كتابة العنوان والتاجات ورابط الشراء.",
              },
              {
                step: "05",
                title: "تتبع العمولات والتحسين الذاتي",
                icon: "📈",
                desc: "يراقب Tracker Agent عدد المشاهدات والنقرات والمبيعات، ويقوم محرك القرار (Brain) بتعديل الاستراتيجية واقتراح تحسينات لحملتك في الوقت الفعلي.",
              },
              {
                step: "06",
                title: "شاهد الشرح الكامل في 60 ثانية",
                icon: "▶️",
                desc: "هل تريد رؤية كل هذه الخطوات في بث محاكاة تفاعلي حي؟ قم بزيارة صفحة فيديو الشرح الآن لمشاهدة دورة العمل من البداية حتى النهاية.",
                link: "/demo",
                linkText: "شاهد Demo الآن ←",
              },
            ].map((card, idx) => (
              <div key={idx} className="bg-[#130d2a]/90 border border-purple-900/50 rounded-3xl p-6 hover:border-cyan-400/50 transition-all flex flex-col justify-between relative overflow-hidden group">
                ...
                {card.link && (
                  <a href={card.link} className="mt-4 inline-block text-sm font-bold text-cyan-400 hover:text-white transition-colors">
                    {card.linkText}
                  </a>
                )}
              </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#130d2a] border border-purple-800/40 rounded-2xl p-6">
              ...
              <a href="/privacy" className="text-xs text-cyan-400 hover:underline">اقرأ سياسة الخصوصية ←</a>
            </div>
            ...
            <div className="bg-[#130d2a] border border-purple-800/40 rounded-2xl p-6">
              ...
              <a href="/demo" className="text-xs text-cyan-400 hover:underline">شاهد الديمو التفاعلي ←</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-purple-900/40 bg-[#070410] py-10 px-6 text-sm text-purple-300" dir="rtl">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <img src="/logo-1024.jpg" alt="Logo" className="w-8 h-8 rounded-lg object-cover border border-purple-500/30" />
          ...
          <div className="flex flex-wrap justify-center gap-6 text-xs md:text-sm font-medium">
            ...
            <a href="/demo" className="text-cyan-400 hover:text-white transition-colors">▶ الشرح (Demo)</a>
            ...
            <a href="/login" className="text-purple-400 hover:text-white transition-colors font-bold">تسجيل الدخول</a>
          </div>
